(function() {/*
	...
	*/
	...
	sum = calculator(subtracion);
	if( sum ){

		number1 = 10;
		number2 = 20;

		console.log(showOperationMessage(subtracion,number1,number2), sum(number1,number2));
	...
	if( sum ){
		...
		console.log(showOperationMessage(multiplication,number1,number2), sum(number1,number2));
	...
	if( sum ){
		...
		console.log(showOperationMessage(division,number1,number2), sum(number1,number2));
	...
	if( sum ){
		...
		console.log(showOperationMessage(mod,number1,number2), sum(number1,number2));
